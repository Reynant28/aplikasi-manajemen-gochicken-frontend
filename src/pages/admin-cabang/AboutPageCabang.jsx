            ...
            <div className="flex-1">
              ...
              <div className="mt-6 p-4 bg-blue-50 rounded-lg border border-blue-200">
                <p className="text-sm text-blue-700">
                  <strong>Penting:</strong> Backup database secara berkala untuk
                  mencegah kehilangan data. File backup berisi semua data
                  transaksi, produk, karyawan, dan pengeluaran.
                </p>
              </div>
            </div>
