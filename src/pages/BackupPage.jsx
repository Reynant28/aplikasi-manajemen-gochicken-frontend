...
const BackupPage = () => {
    ...
    const handleBackup = async () => {
        ...
        try {
            ...
            const errorMessage = error.response?.data?.message || "Gagal membuat backup database";
            setMessage({ 
                type: "error", 
                text: errorMessage
            });
    ...
    const handleClearHistory = async () => {
        ...
        try {
            ...
            const errorMessage = error.response?.data?.message || "Gagal menghapus riwayat backup";
            setMessage({ 
                type: "error", 
                text: errorMessage
            });
            ...
            <motion.div className="space-y-6" initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
                        ...
                        <div className="flex-1">
                            ...
                            <div className="space-y-3 text-sm text-gray-600 mb-4">
                                <div className="flex items-center gap-2">
                                    ...
                                    <span>Format file: <strong>SQL</strong> (MySQL Dump)</span>
                                </div>
                                <div className="flex items-center gap-2">
                                    <Server size={16} className="text-gray-400" />
                                    <span>Metode: <strong>mysqldump</strong> + fallback manual</span>
                                </div>
                                <div className="flex items-center gap-2">
                                ...
                                <div className="flex items-center gap-2">
                                    ...
                                    <span>Total backup: <strong>{backupHistory.length} file</strong></span>
                                </div>
                            </div>

                            <div className="p-4 bg-blue-50 rounded-lg border border-blue-200">
                                <p className="text-sm text-blue-700">
                                    <strong>Penting:</strong> Backup database SQL berisi seluruh struktur dan data database. 
                                    File dapat digunakan untuk restore database lengkap menggunakan MySQL atau phpMyAdmin.
                                </p>
                            </div>
                        </div>
                ...
                <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
                    <div className="flex justify-between items-center mb-4">
                        <h3 className="text-lg font-semibold text-gray-800">Riwayat Backup</h3>
                                ...
                                >
                                    <div className="flex items-center gap-3">
                                        <div className={`w-10 h-10 rounded-xl flex items-center justify-center ${
                                            getStatusBgColor(backup.success)
                                        }`}>
                                    ...
                                    <div className="text-right">
                                        ...
                                        <p className={`text-xs font-semibold ${getStatusColor(backup.success)}`}>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-4">
                        ...
                        <ul className="text-sm text-yellow-700 space-y-1">
                            ...
                            <li>• File SQL dapat di-restore menggunakan MySQL atau phpMyAdmin</li>
                            <li>• Simpan file backup di lokasi yang aman dan terenkripsi</li>
                            <li>• Test restore backup secara periodik untuk memastikan integritas</li>
                        </ul>
                    </div>
                                ...
                                <div className="flex items-center gap-3 p-4 bg-red-50 border border-red-200 rounded-lg">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-red-700 mt-1">
                                            Anda akan menghapus semua riwayat backup. Tindakan ini tidak dapat dibatalkan.
                                        </p>
                                    </div>
                                </div>
