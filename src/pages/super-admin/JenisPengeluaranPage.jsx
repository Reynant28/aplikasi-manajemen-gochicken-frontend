...
const JenisPengeluaranPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (editingJenis) {
        await axios.put(
          `${API_URL}/jenis-pengeluaran/${editingJenis.id_jenis}`,
          formData,
          {
            headers: { Authorization: `Bearer ${token}` },
          }
        ...
        setMessage({
          type: "success",
          text: "Jenis pengeluaran berhasil diperbarui!",
        });
      } else {
        ...
        setMessage({
          type: "success",
          text: "Jenis pengeluaran berhasil ditambahkan!",
        });
      }
      ...
      const errorMsg =
        err.response?.data?.message || "Gagal menyimpan jenis pengeluaran";
  ...
  const handleDelete = async () => {
    ...
    try {
      await axios.delete(
        `${API_URL}/jenis-pengeluaran/${deleteJenis.id_jenis}`,
        {
          headers: { Authorization: `Bearer ${token}` },
        }
      );
      setMessage({
        type: "success",
        text: "Jenis pengeluaran berhasil dihapus!",
      });
      await fetchJenisPengeluaran();
        ...
        <div className="flex flex-col sm:flex-row justify-between sm:items-center gap-4">
          <div>
            ...
            <p className="text-gray-500 text-sm sm:text-base">
              Kelola kategori dan jenis pengeluaran untuk laporan keuangan
            </p>
          </div>
          <button
        ...
        {!loading && !error && filteredJenisPengeluaran.length === 0 && (
          <div className="text-center py-12">
            ...
            <p className="text-gray-500 mt-4">
              {searchTerm
                ? "Tidak ada jenis pengeluaran yang sesuai dengan pencarian"
          ...
          >
            ...
            >
              ...
              <p className="text-sm text-gray-500 mb-6">
                Apakah Anda yakin ingin menghapus jenis pengeluaran{" "}
                <strong>"{deleteJenis.jenis_pengeluaran}"</strong>? Tindakan ini
