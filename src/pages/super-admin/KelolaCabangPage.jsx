          ...
          <form onSubmit={onSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  onChange({ ...cabangData, nama_cabang: e.target.value })
                }
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  onChange({ ...cabangData, alamat: e.target.value })
                }
                className="w-full border border-gray-300 rounded-lg px-3 py-2 text-gray-800 focus:ring-2 focus:ring-red-500 focus:border-red-500 transition"
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  onChange({ ...cabangData, telepon: e.target.value })
                }
                className="w-full border border-gray-300 rounded-lg px-3 py-2 text-gray-800 focus:ring-2 focus:ring-red-500 focus:border-red-500 transition"
            ...
            {/* Password field for both Add and Edit */}
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2">
                Password Cabang{" "}
                {isEdit && (
              ...
              <input
                ...
                onChange={(e) =>
                  onChange({ ...cabangData, password_cabang: e.target.value })
                }
                className="w-full border border-gray-300 rounded-lg px-3 py-2 text-gray-800 focus:ring-2 focus:ring-red-500 focus:border-red-500 transition"
                placeholder={
                  isEdit
                ...
                required={!isEdit} // Only required for new branches
              />
            </div>
