        ...
        <main className="flex-1 overflow-x-hidden overflow-y-auto bg-gray-50 p-6 scrollbar-hide">
          <div className="flex justify-between items-center mb-6">
            ...
            <div className="flex items-center space-x-4">
              ...
              <button className="bg-white border border-gray-300 px-5 py-2 rounded-lg font-semibold hover:bg-gray-50">
                Filter
              </button>
            </div>
          </div>
          ...
          <div className="flex items-center space-x-2 mb-6">
            <button className="bg-green-100 text-green-700 px-4 py-1.5 rounded-full font-semibold">
              All Users
            </button>
            <button className="bg-white border border-gray-300 px-4 py-1.5 rounded-full font-semibold text-gray-600 hover:bg-gray-50">
              Add Branch +
            </button>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            {/* Metric Cards Grid - 6 columns for large screen */}
            <div className="lg:col-span-3 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
              ...
              <DashboardCard title="Engagement Rate">
                ...
                <div className="h-16 w-full bg-gray-200 rounded-md flex items-end justify-between px-1">
                  ...
                  ></div>
                  <div
                    className="w-3 bg-green-600 rounded-t-sm"
                    style={{ height: "90%" }}
                  ></div>
                  <div
                    className="w-3 bg-gray-300 rounded-t-sm"
